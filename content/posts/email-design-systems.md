...
![Old software icons.](./images/email-design-systems/background.png)
...
![Spotify brand guide homepage.](./images/email-design-systems/brand-guide.png)
...
![Mailchimp pattern library grid page.](./images/email-design-systems/pattern-library.png)
...
![Stacks email homepage.](./images/email-design-systems/stacks.png)
...
![Simpsons dog and cat rolling around on pile of money.](./images/email-design-systems/simpsons.gif)
...
![Six old Stack Overflow emails.](./images/email-design-systems/old-emails.png)
...
![Cartoon of caveman selling a wheel.](./images/email-design-systems/wheel.png)
...
![Blinking cursor.](./images/email-design-systems/cursor.gif)
...
![Our brainstorm in Google Docs.](./images/email-design-systems/brainstorm.png)
...
![Progression of Stacks emails.](./images/email-design-systems/stacks-emails.png)
...
![Button vs. tag diagram.](./images/email-design-systems/button-vs-tag.png)
...
![Example of email template being used incorrectly.](./images/email-design-systems/wrong-docs.png)
...
![Giant lego aircraft carrier.](./images/email-design-systems/lego-aircraft-carrier.jpg)
...
![Examples of email designs.](./images/email-design-systems/announcements.png)
