...
var data = {
    labels: ["Interface Design", "Website Design", "Product Design", "Email Design", "HTML & CSS", "JavaScript (jQuery)", "Demos & Presentations", "Leading Teams"],
    datasets: [
        {
            label: "Percieved Interest",
            fillColor: "rgba(97,193,145,.2)",
            strokeColor: "rgba(97,193,145,.7)",
            pointColor: "rgba(97,193,145,.7)",
            pointHighlightStroke: "rgba(97,193,145,.7)",
            data: [100, 70, 85, 80, 95, 75, 90, 100]
        },
        {
            label: "Relative Skill",
            fillColor: "rgba(43,176,212,.2)",
            strokeColor: "rgba(43,176,212,.7)",
            pointColor: "rgba(43,176,212,.7)",
            pointHighlightStroke: "rgba(43,176,212,.7)",
            data: [85, 80, 70, 80, 85, 60, 75, 50]
        }
    ]
};
