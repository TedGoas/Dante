...
module.exports = function clickToPlayVideo(poster, video, alt, width, height, posterObjectViewBox) {
  ...
  return env.renderString(templateSource, {
    ...
    width: parsedWidth,
    height: parsedHeight,
    posterObjectViewBox: posterObjectViewBox ? String(posterObjectViewBox).trim() : ''
  });
};
