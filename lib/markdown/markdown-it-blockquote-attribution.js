...
/**
 * Detects `- [cite](href)` / `– [cite](href)` at end of paragraph; strips it from quote body token.
 * @returns {string|null} inner HTML for <footer>, or null
 */
...
module.exports = function markdownItblockquoteAttribution(md) {
  ...
  md.core.ruler.after("inline", "blockquote_attribution_footer", (state) => {
    ...
    for (let i = 0; i < tokens.length; i++) {
      ...
      /* Attribution link only appears in `<footer>`; strip from `<p>` children */
