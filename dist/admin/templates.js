...
output += " ] [ text-800 md:text-900 leading-tight ] [ p-name ]\">I’m a reliable product designer and front-end developer working on websites, applications, and HTML emails.</h1>\n    ";
...
try {
var parentTemplate = null;
output += "<footer role=\"contentinfo\" class=\"site-footer\">\n  <div class=\"wrapper\">\n      Design and code (except graphics) are open source on <a href=\"https://github.com/TedGoas/Dante\">GitHub</a>. See the <a href=\"https://github.com/TedGoas/Dante/pull/100\">pull request</a> for the current design, or read the <a href=\"/humans.txt\">credits</a>.\n  </div>\n</footer>\n";
if(parentTemplate) {
parentTemplate.rootRenderFunc(env, context, frame, runtime, cb);
} else {
cb(null, output);
...
output += "</span>\n        <span class=\"\" aria-hidden=\"true\">\n          <img src=\"/images/site/tg-sig-logo.svg\" alt=\"Ted Goas.\" width=\"197\" height=\"97\">\n        </span>\n      </a>\n      <p>Designing remotely at Stack Overflow</p>\n      ";
var tasks = [];
tasks.push(
function(callback) {
