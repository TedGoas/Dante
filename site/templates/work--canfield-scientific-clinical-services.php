...
<article>
	...
	<figure class="my7">
		<img src="/assets/images/work/canfield-clinical-services/wireframe.jpg" width="1000" height="450" alt="A few iterations of a clinical study dashboard." class="bordered">
	...
	<figure class="my7">
		<img src="/assets/images/work/canfield-clinical-services/segmented-bar-graph.png" width="1100" height="800" alt="A segmented bar graph for clinical site visits." class="bordered">
	...
	<figure class="my7 w100">
		<img src="/assets/images/work/canfield-clinical-services/browsers.jpg" width="1000" height="400" alt="The site rendered in internet explorer 7 and chrome, side by side.">
	...
	<figure class="my7">
		<img src="/assets/images/work/canfield-clinical-services/data-table.png" width="1100" height="800" alt="A data table design concept." class="bordered">
	...
	<div class="w100 wmx5">
		<a href="/blog/designing-for-medical" class="card card-small">
			<img src="/assets/images/work/th-medical-design.png" alt="Designing for Medical blog post." height="125" width="125">
			<div>
