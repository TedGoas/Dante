<?php snippet('header') ?>
<div class="body">
	<div class="outside work-hero work-hero--vmc">
	...
	<div class="outside work-section work-section--white-text work-section-challenge1--vmc">
		<div class="inside">
			<div class="work-section-header">
	...
	<div class="outside work-section work-section-challenge2--vmc">
		<div class="inside">
			<div class="work-section-header">
	...
	<div class="outside work-section work-section--white-text work-section-ship--vmc">
		<div class="inside">
			<div class="work-section-header">
	...
	<div class="outside work-section work-section-learn--vmc">
		<div class="inside">
			<div class="work-section-header">
