...
thumb_lg: /assets/img/canfield/thumb-lg.jpg
thumb_sm: /assets/img/canfield/thumb-sm.jpg
year: 2016
---
...
<figure class="unbound">
    <div class="flex gs4 sm:block">
        <div class="flex--cell sm:mb-4">
            <img src="/assets/img/canfield/csw1b.png" alt="Login screen." width="1100" class="sm:mb-4">
        </div>
        <div class="flex--cell">
            <img src="/assets/img/canfield/csw1a.png" alt="Early dashboard prototype." width="1100" class="sm:mb-4">
        </div>
    </div>
...
<figure class="unbound bordered">
    <div class="flex gs4 sm:block">
        <div class="flex--cell">
            <img src="/assets/img/canfield/nexa1.png" alt="." width="768" class="sm:mb-4">
        </div>
        <div class="flex--cell">
            <img src="/assets/img/canfield/nexa2.png" alt="." width="768" class="sm:mb-4">
        </div>
        <div class="flex--cell">
...
<figure class="unbound bordered">
    <div class="flex items-center gs4 sm:block">
        <div class="flex--cell">
            <img src="/assets/img/canfield/email-vectra.jpg" alt="Email announcement for Vectra." width="640" class="sm:mb-4">
        </div>
        <div class="flex--cell">
