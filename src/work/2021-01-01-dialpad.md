...
<figure>
    <div class="grid-dialpad-research sm:block">
        <img src="/assets/img/dialpad/analytics-research1.png" alt="Research guide and summary." width="732" class="first shadow-xl shadow-2xl p-2 bg-white rounded border border-gray-200 border-solid">
        <img src="/assets/img/dialpad/analytics-research2.png" alt="Summarized results." width="673" class="second shadow-xl shadow-2xl p-2 bg-white rounded border border-gray-200 border-solid">
