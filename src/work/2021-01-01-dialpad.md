...
<figure class="mt-12">
    <div class="img-placeholder" data-placeholder="Illustration" aria-label="Illustration"></div>
</figure>
...
<figure>
    <div class="grid-dialpad-analytics sm:block">
        <div class="img-placeholder" data-placeholder="Saving a search." aria-label="Saving a search."></div>
        <div class="img-placeholder" data-placeholder="Creating a call snippet." aria-label="Creating a call snippet."></div>
    </div>
...
<figure class="unbound my-12">
    <div class="img-placeholder" data-placeholder="Design artwork for a heatmap graphic." aria-label="Design artwork for a heatmap graphic."></div>
...
<figure>
    <div class="grid-dialpad-research sm:block">
        <div class="img-placeholder" data-placeholder="Research guide and summary." aria-label="Research guide and summary."></div>
        <div class="img-placeholder" data-placeholder="Summarized results." aria-label="Summarized results."></div>
        <div class="img-placeholder" data-placeholder="Coded research results." aria-label="Coded research results."></div>
    </div>
