  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'fixed z-50 flex h-full w-full flex-col gap-4 bg-background p-6 shadow-lg transition ease-in-out sm:max-w-md',
          side === 'right' && 'inset-y-0 right-0 border-l border-border',
