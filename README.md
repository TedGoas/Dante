...
- Implemented via iframe embed of pre-built prototype bundles committed under [`src/work/img/{case}/prototypes/`](src/work/img/). See [AGENTS.md](AGENTS.md) (*Work gallery: interactive prototypes*).
