...
const parser = require("./jsdom/browser/parser");
...
class JSDOM {
  constructor(input, options = {}) {
    ...
    const { parsingMode, parseOptions } = options.windowOptions;
    if (parsingMode === "html") {
      parser.parseHtmlDocument(documentImpl, html, parseOptions);
    } else {
      parser.parseXmlDocument(documentImpl, html);
    }
