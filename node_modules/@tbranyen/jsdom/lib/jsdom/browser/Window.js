...
function Window(options) {
  ...
  const customElementRegistry = CustomElementRegistry.createImpl([], {
    ownerDocument: idlUtils.implForWrapper(window._document)
  });
  ...
  // This is the last thing to do once all the interfaces are present on the window object
